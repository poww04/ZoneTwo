    ...
    <div class="w-full px-6 lg:px-12">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="flex-shrink-0 flex items-center">
                <a href="/" class="text-5xl font-aesthetic font-bold text-black hover:text-yellow-500 transition">
                    ZoneTwo
                </a>
            </div>
            ...
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <p class="text-black text-lg leading-relaxed">
                        ...
                        @else
                            Welcome! Explore our latest collection of trendy fashion pieces. 
                        @endauth
            ...
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <p class="text-black text-lg leading-relaxed">
                        ...
                        @auth
                            Click on any category above to start browsing our amazing collection. 
                        @else
                            <a href="{{ route('login') }}" class="text-yellow-500 hover:underline">Log in</a> or <a href="{{ route('register') }}" class="text-yellow-500 hover:underline">register</a> to start browsing our amazing collection. 
                        @endauth
